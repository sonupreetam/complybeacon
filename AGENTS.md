...
- OpenTelemetry Collector SDK v1.57.0 / v0.151.0 (component framework, pipeline data, processor interfaces)
- `github.com/gemaraproj/go-gemara` v0.4.0 (compliance evidence model — Gemara v1 schema)
